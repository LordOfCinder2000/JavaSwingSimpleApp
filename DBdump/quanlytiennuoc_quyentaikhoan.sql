...
CREATE TABLE `quyentaikhoan` (
  `MaQTK` int NOT NULL,
  `TenQuyen` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`MaQTK`)
...
LOCK TABLES `quyentaikhoan` WRITE;
/*!40000 ALTER TABLE `quyentaikhoan` DISABLE KEYS */;
INSERT INTO `quyentaikhoan` VALUES (1,'Quản trị'),(2,'Người sử dụng');
/*!40000 ALTER TABLE `quyentaikhoan` ENABLE KEYS */;
UNLOCK TABLES;
